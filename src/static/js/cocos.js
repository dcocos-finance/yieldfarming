...
async function main() {
    ...
    //const DCOCOS_TOKEN_ADDR= "0x693e7B6ae1dDff051d232076ccAd485ae94Ae45f";

    const stakingToken = "0xd17599a79834b255723335f6b5a3db46aeb8a3b4";
    const stakingTokenTicker = "UNI-V2";
    const stake_pool_abi ="";
    
    const rewardPoolAddr = "0xE6C2C96c4ebe675dE0420F29a090a50A464dbEc0";
    const rewardTokenAddr = "0x693e7B6ae1dDff051d232076ccAd485ae94Ae45f";
    const rewardTokenTicker = "dCOCOS";
    ...
    const yamScale = 1//await YAM_TOKEN.yamsScalingFactor() / 1e18;
